		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Auto Config Tool",
									"targetURL": "#AutoConfigTool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AutoConfigTool-display": {
								"semanticObject": "AutoConfigTool",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=autoconfigmasterdetail",
									"url": sap.ui.require.toUrl("autoconfigmasterdetail")
								}
							}
						}
					}
